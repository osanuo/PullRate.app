...
# Terms of Service for PullRate
**Last Updated: March 6, 2026**

## Agreement to Terms
By downloading, installing, or using the PullRate mobile application (the "App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.
...
PullRate is a Pokemon TCG portfolio tracking application for iOS devices that helps users:

- Add and manage a personal card collection with grades, prices, and quantities
- Track the market value of each card over time with price history entries
- Record sales transactions and calculate profit and ROI
- View portfolio analytics including total value, monthly gains, and category breakdowns
- Export collection and sales data as a CSV file
...
### Your Data
You retain all ownership rights to the card collection entries, sales records, price history, photos, tags, and other content you create in the App ("User Content").
...
- Process your User Content to provide App functionality (calculate portfolio value, profit, ROI, analytics, etc.)
...
- Backing up your data (we recommend using the CSV export feature regularly)
- Any consequences of sharing your exported data with others
...
- Recovering deleted cards or sale records
- The content of your User Content

## Subscriptions and Payments

### In-App Purchases
PullRate offers optional premium features ("PullRate Premium") through in-app purchases:

- **Free Features**: Core card tracking and sales recording is available for free
- **PullRate Premium**: Advanced features including unlimited cards, custom collections & folders, full analytics dashboard, and advanced profit & ROI analytics
- **Pricing**: Monthly (€3.99/month) or Annual (€39.99/year) — current prices are displayed in the App and App Store in your local currency
- **Free Trial**: Both plans include a 14-day free trial for new subscribers
...
### Free Trials
- You must cancel before the 14-day trial period ends to avoid being charged
...
**Please review our Privacy Policy at**: https://osanuo.github.io/PullRate.app/privacypolicy/

The Privacy Policy is incorporated into these Terms by reference.

## Intellectual Property
The App, including all content, features, functionality, design, text, graphics, logos, and the "PullRate" name and branding, is owned by us and protected by international copyright, trademark, and other intellectual property laws. You may not use our trademarks without our prior written permission.
...
### Data Loss
We strongly recommend regularly exporting your collection and sales data using the built-in CSV export feature. We are not responsible for data loss from any cause.
...
**Website**: https://osanuo.github.io/PullRate.app/
...
- ✅ Use PullRate to track your TCG collection and sales (16+ in EU, 13+ elsewhere)
- ✅ You own all your card data, sales records, and photos
- ✅ PullRate Premium subscriptions renew automatically unless cancelled
- ✅ Both plans include a 14-day free trial — cancel before it ends to avoid charges
- ✅ EU users have 14-day withdrawal rights (with conditions)
- ✅ The App is provided "as is" — please export your CSV data regularly
- ✅ EU users have additional consumer protection rights
- ✅ Contact us with any questions or concerns

**By using PullRate, you agree to these Terms. If you don't agree, please don't use the App.**

---

*These Terms of Service are effective as of March 6, 2026 and comply with Polish law, EU regulations, and applicable consumer protection laws.*
